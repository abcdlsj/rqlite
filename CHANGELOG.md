...
- [PR #2763](https://github.com/rqlite/rqlite/pull/2763): Unit test reaping an installed Snapshot and streamed Snapshot combo. See issue [#2763](https://github.com/rqlite/rqlite/issues/2763).
...
- [PR #2761](https://github.com/rqlite/rqlite/pull/2761): Hard exit if FSM Restore fails post database-swap.
...
- [PR #2656](https://github.com/rqlite/rqlite/pull/2656): Upgrade dependencies via `go get`.
...
- [PR #2648](https://github.com/rqlite/rqlite/pull/2648): Fall back to IEEE CRC32 check during upgrade. Fixes issue [#2647](https://github.com/rqlite/rqlite/issues/2647).
...
There are no breaking API changes in this release, nor any changes to how clustering operates. However there have been some command-line option changes:
 - `-on-disk-path` has been removed. It provided little benefit while making it too easy to corrupt a node. To upgrade a rqlite system which uses this flag first [backup your rqlite node](https://rqlite.io/docs/guides/backup/#backing-up-rqlite), deploy a new v10 system, and then [initialize the new deployment](https://rqlite.io/docs/guides/backup/#restoring-from-sqlite) using the backup.
...
- [PR #2504](https://github.com/rqlite/rqlite/pull/2504), [PR #2507](https://github.com/rqlite/rqlite/pull/2507): Encapsulate WAL Staging Directory logic in a type.
...
- [PR #2432](https://github.com/rqlite/rqlite/pull/2432): Order alphabetically output of shell command `.tables`. Fixes issue [#2431](https://github.com/rqlite/rqlite/issues/2431).
...
- [PR #2413](https://github.com/rqlite/rqlite/pull/2413): Move to Go 1.25.5 and upgrade dependencies.
...
- [PR #2403](https://github.com/rqlite/rqlite/pull/2403): Fix `.restore` command in rqlite shell. Fixes issue [#2402](https://github.com/rqlite/rqlite/issues/2402).
...
## v9.3.3 (December 3rd 2025)
### Implementation changes and bug fixes
- [PR #2396](https://github.com/rqlite/rqlite/pull/2396): Address issues flagged by static analysis. Thanks @The127
- [PR #2397](https://github.com/rqlite/rqlite/pull/2397): Upgrade SQL parser. Fixes issue [#2394](https://github.com/rqlite/rqlite/issues/2394)
...
- [PR #2386](https://github.com/rqlite/rqlite/pull/2386): Small improvements to the CLI help message.
- [PR #2388](https://github.com/rqlite/rqlite/pull/2388): Upgrade dependencies.
